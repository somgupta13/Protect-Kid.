...
public class Register extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {String uid=(String) request.getParameter("uid");
            ...
            if(rs>0)
            {
                out.println("<b>You Are Registered Successfully</b>");
                out.println("<a href=Login.jsp>Login Now</a>");
            }
            
           
        } catch (SQLException ex) {
            Logger.getLogger(Register.class.getName()).log(Level.SEVERE, null, ex);out.println(ex);
        }
    }
