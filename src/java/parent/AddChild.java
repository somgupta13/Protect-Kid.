    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        try {
            ...
            PreparedStatement ps=con.prepareStatement("insert into child (cid,child_Nmae,Date_Of_Birth,uid) values(?,?,?,?)");
            ...
            if(n>0)
                    {
                         out.println("Child Added<br>");
                        out.println("<a href=ParentHome.jsp>Home</a><br>");
                    }
            else
                {
                        out.println("Child not added<br>");
                        out.println("<a href=AddChild.jsp>Try Again</a><br>");
                    }
